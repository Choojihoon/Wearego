...
(function (factory) {
    ...
    var buildLayoutInfo = function ($editor) {
      ...
      if ($editor.hasClass('note-air-editor')) {
        ...
        return {
          ...
          codable: makeFinder('.note-codable'), /*추지훈*/
  ...
  var EventHandler = function () {
    ...
    this.insertImages = function (layoutInfo, files) {
      ...
      console.log('callbacks              ' + callbacks); /* 추지훈 */
      console.log(callbacks);/* 추지훈 */
      var options = $editor.data('options');
      console.log('options              ' + options);/* 추지훈 */
      console.log(options);/* 추지훈 */
  ...
  var Renderer = function () {
    ...
    this.createLayoutByFrame = function ($holder, options) {
      ...
      //031. create codable
      $('<textarea class="note-codable" style="display:none"></textarea> ').prependTo($editingArea);/* 추지훈*/
